...
# -I: Tell g++ where to look for header files
...
# Create a list of `.cpp` input files found within the `src` directory by doing a recursive search
...
CXX_OBJECTS_NO_MAIN := $(filter-out build/main.o,$(CXX_OBJECTS))
