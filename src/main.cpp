...
int main(int argc, char** argv) {
  ...
  std::cout << "age: " << age << " provided? "
            << parser.was_parameter_provided("age") << std::endl;

  auto name = parser.get<std::string>("name");
  std::cout << "name: " << name << " provided? "
            << parser.was_parameter_provided("name") << std::endl;

  auto f = parser.get<double>("coolness-factor");
  std::cout << "coolness-factor: " << f << " provided? "
            << parser.was_parameter_provided("coolness-factor") << std::endl;

  auto banana = parser.get<Banana>("banana");
  std::cout << "banana: " << banana << " provided? "
            << parser.was_parameter_provided("banana") << std::endl;
